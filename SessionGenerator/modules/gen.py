...
async def gen_session(
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("@crazy_adda"))
        else:
            ...
            await client.join_chat("crazy_adda")
    except KeyError:
        pass
    try:
